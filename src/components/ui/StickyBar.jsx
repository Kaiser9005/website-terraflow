...
export default function StickyBar({ scrollTo }) {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const demoTop = demoSection ? demoSection.getBoundingClientRect().top : Infinity;
      // Show after 30% scroll, hide when demo section is visible
      setVisible(scrollPercent > 0.3 && demoTop > window.innerHeight * 0.5);
    };
